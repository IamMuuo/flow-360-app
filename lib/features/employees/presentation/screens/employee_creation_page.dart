...
class _EmployeeCreationPageState extends State<EmployeeCreationPage> {
  ...
  Future<void> _createEmployee() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to create employee: ${e.message}')),
        );
      }
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                _buildTextField(
                  ...
                  obscureText: true, // Obscure the text for passwords
                ),
                const SizedBox(height: 24),
                FilledButton(
